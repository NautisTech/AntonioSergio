...
export const metadata = {
	title: "Main Services 3 Dark || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
	description:
										...
										<div className="row text-center">
											<div className="col-md-8 offset-md-2">
												<p className="section-descr mb-50 mb-sm-40">
													...
													creative services? Contact
													us and get free online
									...
									<div className="row wow fadeInUp">
										<div className="col-md-7 offset-md-5 col-lg-6 offset-lg-6 col-xl-5 offset-xl-7">
											<h2 className="section-title mb-40 mb-sm-30">
												Design Jumpstart for Your
												Business
											</h2>
											<p className="mb-50 mb-sm-40">
												Praesent venenatis justo in
												ultrices tempor. Donec maximus,
												dolor a condimentum congue,
												tellus nisi dictum magna, uttere
												lorem ipsum viverra massa ex sit
												amet nulla. Duis lobortis nisl
