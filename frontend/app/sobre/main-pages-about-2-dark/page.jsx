...
export const metadata = {
	title: "Main About 2 Dark || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
	description:
										...
										<div className="col-sm-8 col-lg-6 col-xl-4 offset-xl-1 mt-n10">
											...
											>
												...
												<p className="text-gray">
													...
													we are committed to
													producing work that not only
													looks amazing but also
									...
									<div className="row">
										<div className="col-lg-4 mb-md-60 mb-xs-50">
											...
											<p
												...
												data-wow-delay="0.1s"
											>
												We provide the effective ideas
												that grow businesses of our
												clients.
											</p>
											<div
