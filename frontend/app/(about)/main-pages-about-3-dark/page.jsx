...
export const metadata = {
	title: "Main About 3 Dark || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
	description:
				...
				<div className="dark-mode">
					<div className="page bg-dark-1" id="top">
						...
						<main id="main">
											...
											>
												...
												<div>
													...
													<p className="mb-50">
														...
														maximus, eget viverra
														sem aliquam. Donec
														blandit ante nunc, nec
														pellentesque arcu
														egestas a lorem.
													</p>
													{/* Features List */}
										...
										<div className="row position-relative">
											<div className="col-md-6 col-lg-5 mb-md-50 mb-sm-30">
												...
												<p className="text-gray mb-0">
													...
													Nam pulvinar vitae neque et
													porttitor. Integer non
													dapibus diam, ac eleifend
													lectus. In maximus ligula
							...
							<hr
								className={`mt-0 mb-0 ${dark ? "white" : ""}`}
							/>
							<section
								className={`page-section  ${
									dark
										? "bg-dark-1 light-content z-index-1"
										: ""
								}`}
							>
								<div className="container position-relative">
									...
									<div className="row text-center wow fadeInUp">
										<div className="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
											<p className="section-descr mb-50 mb-sm-30">
												The power of design help us to
