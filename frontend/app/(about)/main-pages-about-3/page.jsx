...
export const metadata = {
	title: "Main About 3 || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
	description:
									...
									<div className="col-sm-7 col-xl-6 offset-xl-1 mt-n10">
										...
										>
											...
											<p className="text-gray mb-40">
												...
												beautiful and engaging digital
												experiences. We work closely
												with our clients to develop
												websites, apps, and other
												digital products that are not
												only visually stunning but also
												intuitive and user-friendly. Our
												design process is iterative and
												collaborative, and we always
												strive to ensure that our
												clients are completely satisfied
												with the final product. Finally,
								...
								<div className="container">
										...
										<div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
											...
											<h3 className="section-title mb-50 mb-sm-30">
												<span
													...
													data-splitting="chars"
												>
													Discover the people who make
													our web studio stand out.
												</span>
											</h3>
										</div>
									</div>
									...
									>
										...
										{teamMembers.map((elm, i) => (
											<div
												key={i}
												className="col-sm-6 col-lg-3 mt-40"
											>
									...
									<div className="row mb-n30">
										...
										<div className="col-md-12 col-lg-3 mb-md-50">
											...
											<p className="text-gray mb-0">
												...
												casume adipisin elit. Maximus
												ligula semper metus pellentesque
												mattis volutpat, lorem diam
												enim.
											</p>
										</div>
										{/* End Text */}
									...
									<div className="col-lg-6 mt-n30 mt-md-0 mb-30 mb-md-0">
										...
										>
											...
											<div>
												...
												<p className="mb-50">
													Phasellus nisl lectus,
													tincidunt eget fermentum
													quis, accumsan a sem
													efficitur augue ac ex
													maximus, eget viverra sem
													aliquam. Donec blandit ante
													nunc, nec pellentesque arcu
													egestas a lorem.
												</p>
												{/* Features List */}
									...
									<div className="row position-relative">
										<div className="col-md-6 col-lg-5 mb-md-50 mb-sm-30">
											...
											<p className="text-gray mb-0">
												...
												porttitor. Integer non dapibus
												diam, ac eleifend lectus. In
												maximus ligula semper metus
												pellentesque mattis. Maecenas
												volutpat, diam enim sagittis
												quam.
											</p>
										</div>
										<div className="col-md-6 offset-lg-1 pt-10 pt-sm-0">
											...
											{progressData.map((elm, i) => (
												<div
													key={i}
													className="progress tpl-progress"
												>
													<div
								...
								<div className="row text-center wow fadeInUp">
									<div className="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
										<p className="section-descr mb-50 mb-sm-30">
											The power of design help us to solve
											complex problems and cultivate
											business solutions.
										</p>
