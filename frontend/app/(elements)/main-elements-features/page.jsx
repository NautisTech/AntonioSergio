										...
										<div className="col-md-6 col-lg-4 d-flex align-items-stretch mb-30">
											<div className="services-3-item round text-center">
												...
												>
													...
													<div className="services-3-text">
														In traditional
														animation, images are
														drawn or painted by hand
														on transparent celluloid
														sheets to be
														photographed and
														exhibited on film or
														other media.
													</div>
												</div>
											</div>
											...
											<div className="services-3-item round text-center">
												...
												>
													...
													<div className="services-3-text">
														...
														simple single static
														page of plain text to
											...
											<div className="services-3-item round text-center">
												...
												>
													...
													<div className="services-3-text">
														...
														done by the seller or
														retailer. Sometimes
														tasks are contracted to
										...
										<div className="col-lg-5 col-xl-5 offset-xl-1 d-flex align-items-center mb-md-60 mb-sm-40">
											<div className="w-100">
												...
												<p className="section-descr mb-50 mb-sm-30">
													A static website stores a
													unique file for every page
													of a static website. Each
									...
									<div className="row mt-n30">
										...
										>
											<div className="features-2-item pt-sm-40 pb-sm-40">
												...
												<div className="features-2-descr">
													Integer commodo mi ut velit
													bibendum eleifend. Duis
													nulla lectus, pharetra eu
													rhoncus id, pharetra ut
													turpis.
												</div>
											</div>
										</div>
										...
										>
											<div className="features-2-item pt-sm-40 pb-sm-40">
												...
												<div className="features-2-descr">
													Doneck maximus, dolor a
													condimentum congue, tellus
													nisi dictum magna, ut
													viverra massa ex sit amet
													nulla.
												</div>
											</div>
										</div>
										...
										>
											<div className="features-2-item pt-sm-40 pb-sm-40">
												...
												<div className="features-2-descr">
													Curabitur efficitur, nibh
													sed vestibulum facilisis,
													libero lacus accumsan erat,
													quis ultrices risus urna a
													lectus.
												</div>
											</div>
										</div>
									...
									<div className="row mt-n30">
										...
										>
											<div className="alt-features-item box-shadow text-center mt-30">
												...
												<div className="alt-features-descr">
													Fusce aliquet quam eget
													neque ultrices elementum
													felis id arcu blandit
													sagittis.
												</div>
											</div>
										</div>
										...
										>
											<div className="alt-features-item box-shadow text-center mt-30">
												...
												<div className="alt-features-descr">
													Maecenas volutpat, diam
													enime volutpa cramas luctus
													interdum sodales.
												</div>
											</div>
										</div>
										...
										>
											<div className="alt-features-item box-shadow text-center mt-30">
												...
												<div className="alt-features-descr">
													Vivamus varius, nisi vel
													dictum tempor, libero nisl
													iaculis est, ut rutrum elit
													ante ac velit.
												</div>
											</div>
										</div>
