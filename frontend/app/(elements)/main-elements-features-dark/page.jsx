											...
											<div className="col-lg-5 col-xl-5 offset-xl-1 d-flex align-items-center mb-md-60 mb-sm-40">
												<div className="w-100">
													...
													<p className="section-descr mb-50 mb-sm-30">
														A static website stores
														a unique file for every
														page of a static
														website. Each time that
														page is requested, the
														same content is
														returned.
													</p>
													{/* Numbers */}
											...
											>
												<div className="features-2-item pt-sm-40 pb-sm-40">
													...
													<div className="features-2-descr">
														Integer commodo mi ut
														velit bibendum eleifend.
														Duis nulla lectus,
														pharetra eu rhoncus id,
														pharetra ut turpis.
													</div>
												</div>
											</div>
											...
											>
												<div className="features-2-item pt-sm-40 pb-sm-40">
													...
													<div className="features-2-descr">
														Curabitur efficitur,
														nibh sed vestibulum
														facilisis, libero lacus
														accumsan erat, quis
														ultrices risus urna a
														lectus.
													</div>
												</div>
											</div>
											...
											>
												<div className="alt-features-item box-shadow text-center mt-30">
													...
													<div className="alt-features-descr">
														...
														amet rembe adipiscing
														elite Inwege maximus
														ligula imsum.
													</div>
												</div>
											</div>
