...
export default function RegulamentoCursosPage() {
	...
	const content = {
		pt: {
			title: "Regulamento de Cursos",
			subtitle: "Regulamento dos Cursos Profissionais",
			description: "Conteúdo em desenvolvimento.",
		},
		en: {
			title: "Course Regulations",
			subtitle: "Professional Courses Regulations",
