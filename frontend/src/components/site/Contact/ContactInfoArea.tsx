      ...
      <>
         <section className="contact__area grey-bg-2 pt-120 pb-90 p-relative fix">
            ...
            <div className="container">
               <div className="row">
                  <div className="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-5 offset-lg-1 col-md-6" style={{display: 'flex'}}>
                     <div className="contact__item text-center mb-30 transition-3 white-bg" style={{flex: 1}}>
                        ...
                        <div className="contact__content">
                           <h3 className="contact__title">{t("cards.friendlyService.title")}</h3>
                           <p>{t("cards.friendlyService.description")}</p>
                           <Link href={t("cards.friendlyService.linkUrl")} className="tp-btn tp-btn-border">
                              {t("cards.friendlyService.linkText")}
                           </Link>
                        </div>
                     </div>
                  </div>
                  <div className="col-xxl-5 col-xl-5  col-lg-5 col-md-6" style={{display: 'flex'}}>
                     <div className="contact__item text-center mb-30 transition-3 white-bg" style={{flex: 1}}>
                        <div className="contact__icon d-flex justify-content-center align-items-end">
                           <svg viewBox="0 0 24 24">
                        ...
                        <div className="contact__content">
                           <h3 className="contact__title">{t("cards.availableContact.title")}</h3>
                           <p>{t("cards.availableContact.description")}</p>
                           <Link href={t("cards.availableContact.linkUrl")} className="tp-btn tp-btn-border">
                              {t("cards.availableContact.linkText")}
                           </Link>
                        </div>
                     </div>
                  </div>
