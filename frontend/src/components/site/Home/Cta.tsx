              ...
              <div className="col-xxl-6 col-xl-6 col-lg-6">
                <div className="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                  ...
                  <div className="cta__content">
                    <h3 className="cta__title">{t("cta.participate.title")}</h3>
                    <p>
                      {t("cta.participate.description")}
                    </p>
                    <Link href="/contactos" className="tp-btn tp-btn-4">{t("cta.participate.button_text")}</Link>
                  </div>
                </div>
              </div>
              <div className="col-xxl-6 col-xl-6 col-lg-6">
                <div className="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                  ...
                  <div className="cta__content">
                    <h3 className="cta__title">{t("cta.education.title")}</h3>
                    <p>
                      {t("cta.education.description")}
                    </p>
                    <Link href="/contactos" className="tp-btn tp-btn-4">
                      {t("cta.education.button_text")}
                    </Link>
                  </div>
                </div>
              </div>
