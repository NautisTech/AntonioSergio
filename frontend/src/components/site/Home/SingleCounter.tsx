...
const SingleCounter: React.FC<SingleCounterProps> = ({
  ...
  const borderClass = typeof border === 'string'
    ? border
    : border === false
      ? ''
      : `counter__item-border ${counter_2 ? "counter__item-border-2" : ""}`;

  return (
    <>
      <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div
            className={`counter__item d-flex align-items-start ${borderClass}`}
        >
          <div
