...
const RightSide = (props: {
	...
	const projetosAfterTagFilter = selectedTag
		? allProjetos.filter((n: any) =>
				(n.etiquetas ?? []).some(
	...
	const projetosFiltered =
		props.searchValue ?? ""
			? projetosAfterTagFilter.filter((n: any) => {
	...
	return (
		<>
			<div className="col-xxl-4 col-xl-4 col-lg-4">
				<div className="project__sidebar pl-70">
					...
					<div className="sidebar__widget mb-55">
						...
						<div className="sidebar__widget-content">
							<div className="rc__post-wrapper">
								{projetosFiltered?.slice(0, 3).map(projeto => {
