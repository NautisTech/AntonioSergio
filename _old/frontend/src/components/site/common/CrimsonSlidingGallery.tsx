...
interface CrimsonSlidingGalleryProps {
    images: GalleryImage[];
...
export function CrimsonSlidingGallery({
    images,
                        ...
                        {images.map((_, index) => (
                            <motion.button
                                ...
                                style={{
                                    ...
                                    borderRadius: '50%',
                                    border: 'none',
                                    background: currentIndex === index ? '#dc2626' : 'rgba(0,0,0,0.3)', // Crimson red instead of blue
                                    cursor: 'pointer',
