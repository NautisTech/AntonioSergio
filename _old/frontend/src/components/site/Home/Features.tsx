  ...
  const featuresData = [
    {
      ...
      link_text: t('features.items.0.link_text')
    },
    {
      id: 2,
      icon_img: (
      ...
      link_text: t('features.items.1.link_text')
    },
    {
      id: 3,
      icon_img: (
      ...
      link_text: t('features.items.2.link_text')
    },
  ];

  return (
    <>
      <section className="features__area pb-40">
        <div className="container">
          <div className="features__inner p-relative z-index-1">
            <div className="row">
              {featuresData.map((feature) => {
                return (
                  ...
                  >
                    <div className="features__item features__border-right d-sm-flex align-items-start mb-30">
                      <div className="features__icon mr-25">
                        {feature.icon_img}
                      </div>
                      <div className="features__content">
                        <h3 className="features__title">
                          <Link href="/sobre-nos">{feature.title}</Link>
                        </h3>
                        <p>
                          {feature.description}
                        </p>

                        <Link href="/sobre-nos" className="link-btn">
                          {feature.link_text}{" "}
